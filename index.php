...
//$db2 = new SQLite3("/var/db/captiveportallabs.db");
//$statement = $db2->prepare("UPDATE captiveportal SET popup_update_time = 1234 WHERE sessionid='b31b2f6862ef8faf'");
//$result = $statement->execute();
//exec("/bin/echo $row >> /tmp/sessionresult");
...
if ($_POST['abc']){
	...
	$statement = $databasetest->prepare("UPDATE captiveportal SET popup_update_time = {$update_time} WHERE sessionid='{$GET_ID}'");
	$result = $statement->execute();
